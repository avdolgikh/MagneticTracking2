...
% load a test sample
emitter_original_data = load('.\Data\Samples\emitter_sample_12receiv_297_0.04_3_0.001_shift_receivers.dat');
...
dlmwrite(strcat('.\Data\Samples\emitter_noised_', num2str(SNR_dB), 'SNR_', ...
                num2str(receivers_number), 'receiv_', num2str(sample_size), '_0.04_3_0.001_shift_receivers.dat'), ...
                emitter_noised_data);
