...
% load a test sample
emitter_original_data = load('.\Data\Samples\emitter_test_12receiv_1214784_0.025_3_big.dat');
...
dlmwrite(strcat('.\Data\Samples\emitter_noised_', num2str(SNR_dB), 'SNR_', ...
                num2str(receivers_number), 'receiv_', num2str(sample_size), '_big.dat'), emitter_noised_data);
